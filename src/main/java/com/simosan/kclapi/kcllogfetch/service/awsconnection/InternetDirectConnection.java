...
public class InternetDirectConnection implements ConnectionType {
	
	private static final Logger log = LoggerFactory.getLogger(InternetDirectConnection.class);
	...
	public InternetDirectConnection() {

		SimAssumeRoleCred sarc = null;
		try {
			sarc = new SimAssumeRoleCred();
		} catch (Exception e) {
			log.error("InternetDirectConnection SimAssumeRoleCred Exception!");
		}
