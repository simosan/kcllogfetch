...
import com.simosan.kclapi.kcllogfetch.domain.extract.SimKinesisExtractSubscription;
import com.simosan.kclapi.kcllogfetch.domain.extract.SimkinesisExtractData;


public class SimKinesisExtractManageServiceSUBSCRIPTIONパターンTest {
	private static final Logger log = LoggerFactory.getLogger(SimKinesisExtractManageServiceSUBSCRIPTIONパターンTest.class);
	...
	@Test
	public void ExtractSUBSCRITPIONパターン_正常系() throws Exception{
		...
		assertThat(sked,is(instanceOf(SimKinesisExtractSubscription.class)));				
	}
}
