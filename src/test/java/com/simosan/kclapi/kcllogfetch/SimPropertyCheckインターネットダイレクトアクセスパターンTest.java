...
public class SimPropertyCheckインターネットダイレクトアクセスパターンTest {
	private static final Logger log = LoggerFactory.getLogger(SimPropertyCheckインターネットダイレクトアクセスパターンTest.class);
	...
	@Test
	public void SimPropertyCheck_インターネットダイレクトアクセスパターン_正常系() throws Exception{
